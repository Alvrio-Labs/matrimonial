...
// console.log(data.passwordMessage);
...
//   password: Joi.string().pattern(new RegExp(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]+$/)).min(8).message(data.passwordMessage).required()
// });


// console.log(userCreateSchema.password);
...
function validateUser() {
  ...
  return userCreateSchema.validate();
}
